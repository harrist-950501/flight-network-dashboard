...
**arrow + `read_parquet()`**\
We used `arrow` and `read_parquet()` to load the flight dataset from a Parquet file format. Source: We learned about this from the official [Arrow R documentation](https://kou.github.io/arrow-site/docs/r/reference/read_parquet.html) while learning how to import Parquet files in R.
...
Source: We learned about this from the official [dplyr documentation](https://dplyr.tidyverse.org/reference/rename.html) while using it to distinguish similarly named fields after joins.
...
Source: We learned about this from the official [countrycode documentation](https://vincentarelbundock.github.io/countrycode/reference/countrycode.html) while preparing country labels for maps and summaries.
...
Source: We learned about this from the official [R documentation](https://stat.ethz.ch/R-manual/R-devel/library/base/html/cumsum.html) while building the cumulative distribution for global flight concentration.
...
Source: We learned about this from the official [ggplot2 documentation](https://ggplot2.tidyverse.org/reference/scale_continuous.html) while refining chart axes and labels.
...
Source: We learned about this from the official [dplyr documentation](https://dplyr.tidyverse.org/reference/count.html) while looking for a shorter grouped-counting workflow.
...
Source: We learned about this from the official [dplyr documentation](https://dplyr.tidyverse.org/reference/slice.html) while selecting the highest-ranked results for one of our plots.
...
Source: We learned about this from the official [ggplot2 documentation](https://ggplot2.tidyverse.org/reference/geom_text.html) while adding direct labels to improve chart readability.
...
Source: We learned about this from the official [R documentation](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/reorder.factor.html) while ordering categories by data values instead of alphabetically.
...
Source: We learned about this from the official [ggplot2 documentation](https://ggplot2.tidyverse.org/reference/coord_map.html) while adjusting maps and plot layouts.
:::
